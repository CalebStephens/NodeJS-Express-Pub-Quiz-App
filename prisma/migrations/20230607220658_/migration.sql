...
-- AddForeignKey
ALTER TABLE "UserParticipateQuiz" ADD CONSTRAINT "UserParticipateQuiz_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
